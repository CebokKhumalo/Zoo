...
{
    public abstract class ZooWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static ZooWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(ZooWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<ZooDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<ZooDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<ZooDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<ZooDbContext, Task<T>> func)
        {
            T result;
