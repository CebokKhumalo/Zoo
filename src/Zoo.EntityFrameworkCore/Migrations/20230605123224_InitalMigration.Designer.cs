...
namespace Zoo.Migrations
{
    ...
    [Migration("20230605123224_InitalMigration")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Zoo.Domain.Person", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uniqueidentifier");
                    ...
                    b.Property<string>("FirstDateOfEmployment")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.Property<string>("LastDateOfEmployment")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("Zoo.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("Zoo.Authorization.Users.User", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Zoo.Domain.Person", b =>
                {
                    b.HasOne("Zoo.Authorization.Users.User", "User")
                        .WithMany()
                        .HasForeignKey("UserId");
